...
type Options struct {
	...
	EmitMockExecutor            bool              `json:"emit_mock_executor,omitempty" yaml:"emit_mock_executor"`
	...
	DbPackageImportPath         string            `json:"db_package_import_path,omitempty" yaml:"db_package_import_path"`
